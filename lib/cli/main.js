...
var phorecorenode = require('..');
var utils = require('../utils');

function main(servicesPath, additionalServices) {
  /* jshint maxstatements: 100 */

  var version = phorecorenode.version;
  var create = phorecorenode.scaffold.create;
  var add = phorecorenode.scaffold.add;
  var start = phorecorenode.scaffold.start;
  var remove = phorecorenode.scaffold.remove;
  var callMethod = phorecorenode.scaffold.callMethod;
  var findConfig = phorecorenode.scaffold.findConfig;
  var defaultConfig = phorecorenode.scaffold.defaultConfig;
  ...
  program
    ...
    .action(function(services){
      ...
      if (!configInfo) {
        throw new Error('Could not find configuration, see `phorecore-node create --help`');
      }
      var opts = {
      ...
      console.log();
      console.log('    $ phorecore-node add wallet-service');
      console.log('    $ phorecore-node add insight-api');
      console.log();
    });
  ...
  program
    ...
    .action(function(services){
      ...
      console.log('  Examples:');
      console.log();
      console.log('    $ phorecore-node remove wallet-service');
      console.log('    $ phorecore-node remove insight-api');
      console.log();
    });
