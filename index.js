...
module.exports.cli.phorecore = require('./lib/cli/phorecore');
module.exports.cli.phorecored = require('./lib/cli/phorecored');

module.exports.lib = require('phorecore-lib');
